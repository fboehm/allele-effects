...
ggsave("../results/bivariate-analysis-modules.jpg")
```
...
sp_out %>%
  ...
  qtl2pleio::add_pmap(pmap = map.1$`2`) %>%
  ggplot2::ggplot() + ggplot2::geom_line(ggplot2::aes(x = marker_position, y = profile_lod, colour = trait))
ggsave(paste0("../results/bivariate-Chr2-", colnames(phe)[1],"_", colnames(phe)[3], ".jpg"))
```
...
sp_out %>%
  ...
  qtl2pleio::add_pmap(pmap = map.1$`2`) %>%
  ggplot2::ggplot() + ggplot2::geom_line(ggplot2::aes(x = marker_position, y = profile_lod, colour = trait))
ggsave(paste0("../results/bivariate-Chr2-", colnames(phe)[2],"_", colnames(phe)[3], ".jpg"))
```
...
sp_out %>%
  ...
  qtl2pleio::add_pmap(pmap = map.1$`2`) %>%
  ggplot2::ggplot() + ggplot2::geom_line(ggplot2::aes(x = marker_position, y = profile_lod, colour = trait))
ggsave(paste0("../results/trivariate-Chr2.jpg"))
```
...
sp_out %>%
  ...
  ggplot2::ggplot() + ggplot2::geom_line(ggplot2::aes(x = marker_position, y = profile_lod, colour = trait))
ggsave(paste0("../results/bivariate-Chr15-", colnames(phe)[1],"_", colnames(phe)[2], ".jpg"))
```
